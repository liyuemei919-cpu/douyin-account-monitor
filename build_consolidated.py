...
MONITOR_UIDS = [
    ...
    "3049374778393848",     # 油饼久吃（新增）
    "604067175866235",      # 泥不要哇哇叫（新增）
    "7668478121516123194",  # 今天一定早睡（新增）
    "1083498019428832",     # 小小皮（新增）
    "7662902822904562746",  # 咪否（新增）
    "7650764311963681841",  # 青提涩（新增）
    "3313257525808732",     # 凡夫柿子（新增）
    "7660691145656239153",  # 带明第一神童（新增）
    "2574399090487555",     # u米（新增）
    "2860267033869440",     # 巧克力zz（新增）
]
